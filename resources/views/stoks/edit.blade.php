                    ...
                    <div class="card-body">
                        <form action="{{ route('stoks.update', $stok->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama', $stok->nama) }}" placeholder="Masukkan Nama Produk" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('stok') is-invalid @enderror" name="stok" value="{{ old('stok', $stok->stok) }}" placeholder="Masukkan Stok Produk" min="0" oninput="validity.valid||(value='');">
