        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('bahans.update', $bahan->id) }}" method="POST" enctype="multipart/form-data">
                            <h1>Data Bahan</h1>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama', $bahan->nama) }}" placeholder="Masukkan Nama Bahan">
