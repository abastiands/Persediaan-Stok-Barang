                    ...
                    <div class="card-body">
                        <form action="{{ route('penjualans.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="produk-option" name="id_produk">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('terjual') is-invalid @enderror" name="terjual" value="{{ old('terjual') }}" placeholder="Masukkan Jumlah Produk Terjual" min="0" oninput="validity.valid||(value='');">
